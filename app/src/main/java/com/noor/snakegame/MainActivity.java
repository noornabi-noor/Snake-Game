...
public class MainActivity extends AppCompatActivity implements SurfaceHolder.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final AppCompatImageView upBtn = findViewById(R.id.upBtn);
        final AppCompatImageView downBtn = findViewById(R.id.downBtn);
        final AppCompatImageView leftBtn = findViewById(R.id.leftBtn);
        final AppCompatImageView rightBtn = findViewById(R.id.rightBtn);
